...
public class Main {
	...
	public static void main(String[] args) {
		...
		int int_input_one; 
		int int_input_two; 
		boolean again_calculator = true; 

		//Creating stacks for history answers. 
		Stack<String> stack_answers_addition = new Stack<>();
		Stack<String> stack_answers_subtraction = new Stack<>(); 
		Stack<String> stack_answers_multiplication = new Stack<>(); 
		Stack<String> stack_answers_division = new Stack<>(); 
		Stack<String> stack_answers_modular = new Stack<>(); 
		Stack<String> stack_answers_squareRoot = new Stack<>(); 
		Stack<String> stack_answers_powerNumber = new Stack<>(); 
		Stack<String> stack_answers_GCD = new Stack<>(); 
		Stack<String> stack_answers_pythagoreanTheorem = new Stack<>(); 
